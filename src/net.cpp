...
void ThreadMapPort()
{
    ...
    if (r == 1)
    {
        ...
        string strDesc = "PandoraCoin " + FormatFullVersion();
...
static const char *strMainNetDNSSeed[][2] = {
    {"pandoracointools.com", "dnsseed.pandoracointools.com"},
    {"pandoracoinpool.org", "dnsseed.pandoracoinpool.org"},
...
static const char *strTestNetDNSSeed[][2] = {
    {"pandoracointools.com", "testnet-seed.pandoracointools.com"},
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. PandoraCoin is probably already running."), addrBind.ToString().c_str());
        else
